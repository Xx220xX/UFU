...
def GerarGraficos(a: list, b: list, file):
    ...
    y, name, ylabel, xscale = [None, None, None], ['Assintótico', 'Calculado', 'Linear'], ['dB', 'dB', 'Amplitude'],\
                              ['log', 'log', 'linear']
    w, y[0] = Sinais.bodeAssintotico(a, b, wlim=[0.1, 300], poits=10000)
...
GerarGraficos(Sinais.Polinomio(-40, cte=0.1), Sinais.Polinomio(-1, -8), 'out/Grafico de bode H2 ')
GerarGraficos(Sinais.Polinomio(-1, cte=6.4), Sinais.Polinomio(-8, -8), 'out/Grafico de bode Ht ')
